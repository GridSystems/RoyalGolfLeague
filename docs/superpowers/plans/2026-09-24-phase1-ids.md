...
- [ ] **Step 1: Pre-flight** — confirm with the user: weekday evening, nobody scoring, outside Fri 12:00–Sat. Take the **before** snapshot and render:
